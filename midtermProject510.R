...
cat("Position on Tech stocks: $", Tech_position)
...
cat("Position on Health stocks: $", Health_position)
...
# Retail_position - bullish
Retail_position = sum(retail_stocks$Portfolio_Revenue)
cat("Position on Retail stocks: $", Retail_position)
